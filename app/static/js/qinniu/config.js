var uploaderoption = {
    ...
    //uptoken : "0MLvWPnyya1WtPnXFy9KLyGHyFPNdZceomL...", // uptoken 是上传凭证，由其他程序生成
    ...
    flash_swf_url: "{{url_for(main.staticfile,filename='plupload/Moxie.swf')}}" ,//'path/of/plupload/Moxie.swf',  //引入 flash,相对路径
    max_retries: 3,                     // 上传失败最大重试次数
    dragdrop: true,                     // 开启可拖曳上传
    drop_element: 'upload-aira',          // 拖曳上传区域元素的 ID，拖曳文件或文件夹后可触发上传
    chunk_size: '1000kb',                  // 分块上传时，每块的体积
